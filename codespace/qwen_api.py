...
【目标与输出要求】
请根据设备标注数据，按照以下规则重新排布电网设备，在遵循【输出格式示例】要求的情况下，仅输出设备的坐标信息，仅输出设备的坐标信息，仅输出设备的坐标信息。
...
输入数据1上的坐标对应第一张图片，输入数据2上的坐标对应第二张图片。
...
# 使用示例
image_path1 = "4ecd11d6-ea922643e18a06deef5a716682015aea8fd2862bb8.png"  # 改成实际图片路径
image_path2 = "186808be-ea922643e18a06deef5a716682015aea8fd2862bb8.png"  # 第二张图片路径

...
def analyze_linear_model():
    ...
    # 特征名称
    feature_names = [
        'segment_count', 'total_points', 'avg_points', 'max_points', 'min_points',
        'total_length', 'avg_length', 'max_length', 'min_length', 'std_length',
        'x_range', 'y_range', 'area', 'short_ratio', 'abnormal_ratio'
    ]
